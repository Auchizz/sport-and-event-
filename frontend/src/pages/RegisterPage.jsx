    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-pagebg">
      <div className="max-w-4xl w-full grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="hidden md:flex flex-col justify-center p-8 rounded-xl bg-gradient-to-br from-primary to-accent text-white">
          ...
          <p className="mt-3 opacity-90">Create an account to manage your portal access and profile.</p>
        </div>
        <div className="card">
          ...
          <form onSubmit={handleSubmit} className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <input placeholder="Member ID" value={form.studentId} onChange={e=>setForm({...form,studentId:e.target.value})} className="w-full px-3 py-2 border rounded-lg" />
              <input placeholder="Department or Unit" value={form.faculty} onChange={e=>setForm({...form,faculty:e.target.value})} className="w-full px-3 py-2 border rounded-lg" />
            </div>
