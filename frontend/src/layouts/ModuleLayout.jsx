...
export default function ModuleLayout() {
  ...
  return (
    <div className="module-shell sliit-grid p-5 shadow-sliit sm:p-6 lg:p-8">
      <section className="sliit-card overflow-hidden rounded-[2rem] border-sliit-line bg-sliit-bg p-8 text-white shadow-sliit">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-3xl">
            <p className="sliit-pill">Sports Information Module</p>
            <h1 className="sliit-heading mt-5 text-5xl text-white sm:text-6xl">
